...
- Large scrolling aircraft silhouettes generated from ADS-B Radar SVG icons
...
Current generated OLED aircraft bitmap preview:

![Aircraft bitmap preview](docs/aircraft-bitmap-preview.png)
...
Artwork is generated by `tools/generate_aircraft_bitmaps.py` from the SVG silhouettes in `third_party/adsb-radar-icons/`. The generated Arduino header is `arduino-radar/aircraft_bitmaps.h`.

Current broad artwork mapping:

| Firmware bucket | Source icon | Notes |
| --- | --- | --- |
| Helicopter | `a7.svg` | Rotorcraft / ADS-B category `A7` |
| Light prop | `cessna.svg` | Cessna/Piper/small piston style aircraft |
| Twin prop | `dh8a.svg` | Turboprop and regional prop aircraft |
| Business jet | `learjet.svg` | Business jet type codes |
| Airliner | `a320.svg` | General passenger jet fallback |
| Heavy jet | `b747.svg` | Heavy/widebody aircraft |
| Cargo | `md11.svg` | Cargo and freight callsigns |
